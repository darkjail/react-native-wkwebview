...
@interface _SwizzleHelperWK2 : NSObject @end
@implementation _SwizzleHelperWK2
...
-(void)setHideKeyboardAccessoryView:(BOOL)hideKeyboardAccessoryView
{
  ...
  NSString* name = [NSString stringWithFormat:@"%@_SwizzleHelperWK2", subview.class.superclass];
  ...
  if(newClass == nil)
  {
    ...
    Method method = class_getInstanceMethod([_SwizzleHelperWK2 class], @selector(inputAccessoryView));
